...
namespace Manoj.Pomclasses
{
    ...
    {
        public Electronics(IWebDriver driver)
        {
            PageFactory.InitElements(driver, this);
        }
        [FindsBy(How = How.XPath, Using = "//a[@href='sub-category.php?scid=4']")]
        private IWebElement mobile;
            [FindsBy(How = How.XPath, Using = "//a[text()='Micromax Canvas Mega 4G']")]
        private IWebElement lenovo;
        ...
        public IWebElement Mobile { get => mobile; set => mobile = value; }
        ...
        public IWebElement Lenovo { get => lenovo; set => lenovo = value; }
