...
namespace Manoj.Pomclasses
{
    class Jewelery
    {
        public Jewelery(IWebDriver driver)
        {
            PageFactory.InitElements(driver, this);
        }
        [FindsBy(How = How.XPath, Using = "//a[@href='sub-category.php?scid=16']")]
        ...
        public IWebElement Television { get => premium; set => premium = value; }
